...
public class ValidadorDeParametros implements UnidadDeProceso{
	...
	private boolean hayCaracteresRaros(String nombreDelArchivoDeEntrada) {
		...
		if(this.hayArchivoDeEntrada(nombreDelArchivoDeEntrada)){
			...
			boolean hayEnies = nombreDelArchivoDeEntrada.contains("�") || nombreDelArchivoDeEntrada.contains("�");
			boolean hayAcentos = (nombreDelArchivoDeEntrada.contains("�") || nombreDelArchivoDeEntrada.contains("�")) ||
								 (nombreDelArchivoDeEntrada.contains("�") || nombreDelArchivoDeEntrada.contains("�")) ||
								 (nombreDelArchivoDeEntrada.contains("�") || nombreDelArchivoDeEntrada.contains("�")) ||
								 (nombreDelArchivoDeEntrada.contains("�") || nombreDelArchivoDeEntrada.contains("�")) ||
								 (nombreDelArchivoDeEntrada.contains("�") || nombreDelArchivoDeEntrada.contains("�"));
